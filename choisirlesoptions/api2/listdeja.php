		...
		while($row = mysqli_fetch_assoc($res))
		{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$premier' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					$sql4 = "select deuxieme from rendu where option_choix='$premier' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$premier' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$premier' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
			...
			while($row = mysqli_fetch_assoc($res))
			{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$deuxieme' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					$sql4 = "select deuxieme from rendu where option_choix='$deuxieme' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$deuxieme' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$deuxieme' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
			...
			while($row = mysqli_fetch_assoc($res))
			{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$troisieme' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					$sql4 = "select deuxieme from rendu where option_choix='$troisieme' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$troisieme' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$troisieme' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
			...
			while($row = mysqli_fetch_assoc($res))
			{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$quatrieme' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					$sql4 = "select deuxieme from rendu where option_choix='$quatrieme' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$quatrieme' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$quatrieme' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
			...
			while($row = mysqli_fetch_assoc($res))
			{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$cinquieme' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					while($row = mysqli_fetch_assoc($res))
					{
					  ...
					  $sql4 = "select deuxieme from rendu where option_choix='$cinquieme' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$cinquieme' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$cinquieme' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
			...
			while($row = mysqli_fetch_assoc($res))
			{
				...
				elseif($row['deuxieme']==0){
					...
					if(mysqli_query($con, $sql4))
					  ...
					  $sql4 = "select premier from rendu where option_choix='$sixieme' and premier!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['premier']!=''){
				...
				elseif($row['troisieme']==0){
					...
					while($row = mysqli_fetch_assoc($res))
					{
					  ...
					  $sql4 = "select deuxieme from rendu where option_choix='$sixieme' and deuxieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['deuxieme']!=''){
				...
				elseif($row['quatrieme']==0){
					...
					$sql4 = "select troisieme from rendu where option_choix='$sixieme' and troisieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['troisieme']!=''){
				...
				elseif($row['cinquieme']==0){
					...
					$sql4 = "select quatrieme from rendu where option_choix='$sixieme' and quatrieme!='$num_id' ";
					$res = mysqli_query($con,$sql4);
					while($row = mysqli_fetch_assoc($res))
					{
							if($row['quatrieme']!=''){
